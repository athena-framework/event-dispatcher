...
abstract class Athena::EventDispatcher::EventDispatcherInterface
  ...
  #
  # `AED::Listener`'s are executed based on the listener's priority; the higher the value the sooner it gets executed.
  ...
  abstract def listener_priority(event : AED::Event.class, listener : AED::Listener.class) : Int32?
  ...
  abstract def remove_listener(event : AED::Event.class, listener : AED::Listener.class) : Nil
